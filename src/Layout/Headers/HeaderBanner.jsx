export default function HeaderBanner() {
    return (
        <div>
            ...
            <p className=" text-[2.5rem] font-poppins text-blue-200 w-[90vw] text-right">Whether you're looking to boost your general knowledge or challenge your friends in a trivia showdown, I've got you covered. </p>
        </div>
